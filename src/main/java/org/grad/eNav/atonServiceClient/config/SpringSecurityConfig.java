...
import org.grad.eNav.atonServiceClient.config.keycloak.KeycloakGrantedAuthoritiesMapper;
...
class SpringSecurityConfig {
     ...
     */
    @Value("${keycloak.clientId:aton-service-client}")
    private String clientId;

    /**
     * The default application name.
     */
    @Value("${gla.rad.aton-service-client.resources.open:/,/index,/webjars/**,/css/**,/lib/**,/images/**,/src/**}")
