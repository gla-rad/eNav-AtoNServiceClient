...
public class S125ServiceClientSecomRemoveSubscriptionTest {
                ...
                .expectsToReceiveHttpInteraction(
                        ...
                        httpBuilder -> httpBuilder
                                .withRequest(requestBuilder -> requestBuilder
                                        ...
                                        .method("DELETE")
                                        .body(SecomPactDslDefinitions.removeSubscriptionRequestDsl))
                                .willRespondWith(responseBuilder -> responseBuilder
                                        .status(200)
                                        .body(SecomPactDslDefinitions.removeSubscriptionResponseDsl))
                )
                .toPact();
    }
        ...
        return builder
                ...
                .expectsToReceiveHttpInteraction(
                        ...
                        httpBuilder -> httpBuilder
                                ...
                                .willRespondWith(responseBuilder -> responseBuilder
                                        .status(404)
                                        .body(SecomPactDslDefinitions.removeSubscriptionResponseNotFoundDsl))
                )
                .toPact();
    }
